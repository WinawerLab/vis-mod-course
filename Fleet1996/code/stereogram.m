function [I_L,I_R] = stereogram(A,view_type,plotMode)
% Modded by CSB apr 22, 2018, to return the stereogram images as output.
% input is ground druth disparity map
...
if ieNotDefined('view_type');view_type= 'parallel-eyes'; end % can also be 'crossed-eyes'
